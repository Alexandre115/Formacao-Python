class VendaTrakinas:
    """
    Classe para representar uma venda de trakinas,
    calcula o valor total com desconto para compras acima de 20 unidades.
    """
    ...
    def informar_preco_unitario(self):
        """
        Retorna o preço unitário aplicável conforme a quantidade.
        """
        if self.quantidade >= 10:
